...
const WEB_APP_URL =
"https://script.google.com/a/macros/havensafety.com/s/AKfycbyBu-7KiWdSlnM31262V7OK5XF8WE2AdPWkgSNX37ts_pJphcuKOZSPxCH6kjjtM_YH3g/exec";
  if (!keyword) return [];
  ...
  try {
    ...
    switch (request.action) {
      ...
      case "chat":
        result = {
          success: true,
          reply: askKnowledgeBaseAI(request.question)
        };
        break;
      ...
      case "search":
        result = {
          success: true,
          results: searchKnowledge(request.keyword)
        };
        break;
